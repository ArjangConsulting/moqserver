...
/**
 * Studio's top-level theme wrapper.
 *
 * Applies the custom Material color scheme (light or dark), the Studio
 * typography scale, and makes [MaterialTheme] available to all descendants.
 */
@Composable
fun StudioTheme(
