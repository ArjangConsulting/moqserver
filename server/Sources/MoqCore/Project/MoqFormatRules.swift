...
public enum MoqFormatRules {
    ...
    private static let reservedExactPaths: Set<String> = ["/health", "/_admin", "/_auth", "/_addons"]
    private static let reservedPathPrefixes: [String] = ["/_admin/", "/_auth/", "/_addons/"]

    public static func isValidEndpointID(_ id: String) -> Bool {
        id.range(of: endpointIDPattern, options: .regularExpression) != nil
    }

    public static func isValidAddonID(_ id: String) -> Bool {
        id.range(of: addonIDPattern, options: .regularExpression) != nil
    }
