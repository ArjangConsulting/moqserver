...
public enum DiagnosticCode: String, Sendable, Equatable {
    ...
    case bodyEncodingWithoutBody = "E_BODY_ENCODING_WITHOUT_BODY"
    case bodyEncodingOnBodyFile = "E_BODY_ENCODING_ON_BODY_FILE"
    case bodyEncodingRequiresString = "E_BODY_ENCODING_REQUIRES_STRING"
    case invalidBase64Body = "E_INVALID_BASE64_BODY"
